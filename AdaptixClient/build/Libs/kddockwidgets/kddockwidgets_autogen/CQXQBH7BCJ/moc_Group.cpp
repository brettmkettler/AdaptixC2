...
#include "../../../../../Libs/kddockwidgets/qtwidgets/views/Group.h"
...
namespace {
struct qt_meta_tag_ZN13KDDockWidgets9QtWidgets5GroupE_t {};
} // unnamed namespace

template <> constexpr inline auto KDDockWidgets::QtWidgets::Group::qt_create_metaobjectdata<qt_meta_tag_ZN13KDDockWidgets9QtWidgets5GroupE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'numDockWidgetsChanged'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'isInMainWindowChanged'
    ...
    return QtMocHelpers::metaObjectData<Group, qt_meta_tag_ZN13KDDockWidgets9QtWidgets5GroupE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject KDDockWidgets::QtWidgets::Group::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13KDDockWidgets9QtWidgets5GroupE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13KDDockWidgets9QtWidgets5GroupE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13KDDockWidgets9QtWidgets5GroupE_t>.metaTypes,
    nullptr
} };
...
void KDDockWidgets::QtWidgets::Group::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Group::*)()>(_a, &Group::numDockWidgetsChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Group::*)()>(_a, &Group::isInMainWindowChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Group::*)()>(_a, &Group::isFocusedChanged, 2))
            return;
    }
}
...
void *KDDockWidgets::QtWidgets::Group::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13KDDockWidgets9QtWidgets5GroupE_t>.strings))
