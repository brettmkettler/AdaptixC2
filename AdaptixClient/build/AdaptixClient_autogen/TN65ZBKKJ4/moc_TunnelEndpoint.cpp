...
template <> constexpr inline auto TunnelEndpoint::qt_create_metaobjectdata<qt_meta_tag_ZN14TunnelEndpointE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "onStartLpfChannel",
        "",
        "onStartSocks4Channel",
        "onStartSocks5Channel",
        "onStartSocks5AuthChannel"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'onStartLpfChannel'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onStartSocks4Channel'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onStartSocks5Channel'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onStartSocks5AuthChannel'
...
void TunnelEndpoint::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onStartSocks4Channel(); break;
        case 2: _t->onStartSocks5Channel(); break;
        case 3: _t->onStartSocks5AuthChannel(); break;
        default: ;
        }
    }
    (void)_a;
