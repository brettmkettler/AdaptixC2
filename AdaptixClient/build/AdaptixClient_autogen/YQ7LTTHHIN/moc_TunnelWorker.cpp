...
namespace {
struct qt_meta_tag_ZN12TunnelWorkerE_t {};
} // unnamed namespace

template <> constexpr inline auto TunnelWorker::qt_create_metaobjectdata<qt_meta_tag_ZN12TunnelWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const QByteArray &) const>(7, 2, QMC::AccessPrivate, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<TunnelWorker, qt_meta_tag_ZN12TunnelWorkerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TunnelWorker::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12TunnelWorkerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12TunnelWorkerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12TunnelWorkerE_t>.metaTypes,
    nullptr
} };
...
void TunnelWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TunnelWorker::*)()>(_a, &TunnelWorker::finished, 0))
            return;
    }
}
...
void *TunnelWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12TunnelWorkerE_t>.strings))
