...
namespace {
struct qt_meta_tag_ZN15AxScriptManagerE_t {};
} // unnamed namespace

template <> constexpr inline auto AxScriptManager::qt_create_metaobjectdata<qt_meta_tag_ZN15AxScriptManagerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AxScriptManager, qt_meta_tag_ZN15AxScriptManagerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AxScriptManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15AxScriptManagerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15AxScriptManagerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15AxScriptManagerE_t>.metaTypes,
    nullptr
} };
...
void *AxScriptManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15AxScriptManagerE_t>.strings))
